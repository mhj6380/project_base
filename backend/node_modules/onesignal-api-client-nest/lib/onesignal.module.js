...
const onesignal_constants_1 = require("./onesignal.constants");
const onesignal_provider_1 = require("./onesignal.provider");
...
let OneSignalModule = OneSignalModule_1 = class OneSignalModule {
    static forRoot(options) {
        return {
            ...
            providers: onesignal_provider_1.createOneSignalProvider(options),
        };
    }
    ...
    static createAsyncOptionsProvider(options) {
        if (options.useFactory) {
            return {
                provide: onesignal_constants_1.ONESIGNAL_MODULE_OPTIONS,
        ...
        return {
            provide: onesignal_constants_1.ONESIGNAL_MODULE_OPTIONS,
            useFactory: (optionsFactory) => __awaiter(this, void 0, void 0, function* () { return yield optionsFactory.createOneSignalOptions(); }),
