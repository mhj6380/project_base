...
let FeedbackService = class FeedbackService {
    ...
    getFeedbackList(page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const totalCount = yield this.feedbackRepository.count();
            const crmItems = yield this.feedbackRepository
                .createQueryBuilder()
...
FeedbackService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(feedback_entity_1.Feedback)),
